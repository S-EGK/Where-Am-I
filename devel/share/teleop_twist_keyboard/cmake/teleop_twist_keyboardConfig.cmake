...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/segk/where_am_i/src/teleop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/segk/where_am_i/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/segk/where_am_i/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/segk/where_am_i/src/teleop_twist_keyboard/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/segk/where_am_i/devel/lib;/opt/ros/kinetic/lib)
